...
// Insertar en la tabla ventas (incluyendo dirección)
$sql = "INSERT INTO ventas (nombre_cliente, telefono, direccion, item, precio, tipo)
        VALUES ('$nombre', '$telefono', '$direccion', '$item', $precio, '$tipo')";
