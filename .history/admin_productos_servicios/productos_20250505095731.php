...
<body>
  <div class="admin-panel">
    ...
    <div class="form-register">
      ...
      <br><br>
        <button type="button" onclick="window.location.href='inicio_sesion/car_fast.html'">Cancelar</button><br><br>
        <button type="reset">Limpiar</button><br><br>
        <a href="car_fastinicio_sesion/car_fast.html" style="display:inline-block; margin-bottom:10px; padding:8px 16px; background-color:#007BFF; color:white; text-decoration:none; border-radius:4px;">← Salir</a>
