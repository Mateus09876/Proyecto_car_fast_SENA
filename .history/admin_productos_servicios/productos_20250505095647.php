  ...
  <div class="admin-panel">
    ...
    <div class="form-register">
      ...
      <br><br>
        ...
        <a href="inicio_sesion/car_fast.html" style="display:inline-block; margin-bottom:10px; padding:8px 16px; background-color:#007BFF; color:white; text-decoration:none; border-radius:4px;">← </a>
